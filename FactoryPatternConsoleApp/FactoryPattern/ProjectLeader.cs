namespace FactoryPattern
{
    class ProjectLeader : User
    {
        ...
        public ProjectLeader(int id, string userName, string nombre, string apellidoPaterno, string apellidoMaterno)
        {
            _userType = "ProjectLeader";
            _id = id;
            _userName = userName;
            _nombre = nombre;
